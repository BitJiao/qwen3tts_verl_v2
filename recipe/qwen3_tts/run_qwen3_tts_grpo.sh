...
REWARD_SIM_WEIGHT=${REWARD_SIM_WEIGHT:-0.2}
REWARD_JUDGE_WEIGHT=${REWARD_JUDGE_WEIGHT:-0.5}
REWARD_DURATION_WEIGHT=${REWARD_DURATION_WEIGHT:-0.0}
...
export REWARD_WER_WEIGHT
export REWARD_SIM_WEIGHT
export REWARD_JUDGE_WEIGHT
export REWARD_DURATION_WEIGHT
